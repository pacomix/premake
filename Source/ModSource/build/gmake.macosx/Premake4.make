...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../../..
  TARGET     = $(TARGETDIR)/premake4Mod
  DEFINES   += -DNDEBUG -DLUA_USE_MACOSX
  INCLUDES  += -I../../src/host/lua-5.1.4/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -Os -m64 -mmacosx-version-min=10.1
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -Wl,-x -m64 -L/usr/lib64 -lstdc++-static -mmacosx-version-min=10.1 -rdynamic
  LIBS      += 
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../..
  TARGET     = $(TARGETDIR)/premake4ModD
  DEFINES   += -D_DEBUG -DLUA_USE_MACOSX
  INCLUDES  += -I../../src/host/lua-5.1.4/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -g -m64 -mmacosx-version-min=10.1
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -m64 -L/usr/lib64 -lstdc++-static -mmacosx-version-min=10.1 -rdynamic
  LIBS      += 
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
