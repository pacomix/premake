  ...
  newaction 
	{
      ...
      iOS = "iOS"
		...
		onsolution = function(sln)
			-- Assign IDs needed for inter-project dependencies
      premake.generate(sln, "%%.xcworkspace/contents.xcworkspacedata", premake.xcode.preparesolution)
      for _, cfgName in ipairs(sln.configurations) do
        sln.currentScheme = cfgName
        premake.generate(sln, "%%.xcworkspace/xcshareddata/xcschemes/" .. cfgName .. ".xcscheme", premake.xcode.XCScheme)
      end
		end,
