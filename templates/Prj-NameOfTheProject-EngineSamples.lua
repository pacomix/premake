...
projectLocation = "."
projectBaseName = tempSlnPrefix .. "" -- PROCESSED BY VS2PREMAKE.
projectName = projectBaseName -- NOTE: For solutions/projects that shouldn't need a suffix ( ending in 90/100) just delete the buildSystemSuffix variable here.
projectGUID = "" -- PROCESSED BY VS2PREMAKE.
outputFolder = "../../shared/" -- If this variable is not used the specific ones (vars: outputFolderXXXXXXXXXXXXXXXXXX) will be the used instead. 
...
projectReferences = { tempSlnPrefix .. "-Shared - VisionEnginePlugin" .. buildSystemSuffix }   -- Project's references
projectDependencies = ""  -- Project's dependencies
projectBuildConfigs = ""

buildConfigsForProject = { "Debug", "Debug DX11", "Release", "Release DX11" }
...
buildConfigsForProject = { "Debug", "Debug DX11", "Release", "Release DX11" }
buildPlatformsForProject = {  "x32", "x64" } 
end
projectLanguage = "Default" -- Project's language: C, C++, Default
projectPropertySheet = "../../shared/property/VisionApp" -- Property sheet filename. The filename should be only the path + suffix of the filename. Based in the build configuration the correct file is later 
...
if includeBuildConfigs == nil or includeBuildConfigs == "" then -- ACHTUNG!!! REALLY IMPORTANT:  
  includeBuildConfigs = projectBuildConfigs -- Build configs that are set to be build for this project. This variable is set here by default to include the whole build configurations 
                                            -- defined in the variable projectBuildConfigs but IF THIS VARIABLE IS DEFINED IN the Sln-XXXXXXX.lua file this should be removed because
                                            -- then it will be overwriting it.
end

if buildSystem == "vs2008" then
	projectLocation = "../ProjectFilesVC2008"
elseif buildSystem == "vs2010" then
	projectLocation = "../ProjectFilesVC2010"
elseif buildSystem == "vs2012" then
	projectLocation = "../ProjectFilesVC2012"
end
...
outputTargetDebugWin32 = projectName
outputTargetDebugDX11Win32 = projectName
outputTargetDebugNoXIWin32 = ""
outputTargetDebugStaticWin32 = ""
outputTargetDebugStaticMTWin32 = ""
outputTargetDebugX64 = projectName
outputTargetDebugDX11X64 = projectName
outputTargetDebugNoXIX64 = ""
outputTargetDebugStaticX64 = ""
outputTargetDebugStaticMTX64 = ""
outputTargetReleaseWin32 = projectName
outputTargetReleaseDX11Win32 = projectName
outputTargetReleaseNoXIWin32 = ""
outputTargetReleaseStaticWin32 = ""
outputTargetReleaseStaticMTWin32 = ""
outputTargetReleaseX64 = projectName
outputTargetReleaseDX11X64 = projectName
outputTargetReleaseNoXIX64 = ""
outputTargetReleaseStaticX64 = ""
outputTargetReleaseStaticMTX64 = ""
outputTargetDebugPS3 = projectName
outputTargetReleasePS3 = projectName
outputTargetDebugPSP2 = projectName
outputTargetReleasePSP2 = projectName
outputTargetDebugXbox360 = projectName
outputTargetReleaseXbox360 = projectName
...
outputTypeWin = "WindowedApp"
outputTypeXbox360 = "ConsoleApp"
outputTypePS3 = "ConsoleApp"
outputTypePSP2 = "ConsoleApp"

-- Specific PS3 section
targetExtensionExePS3 = ".elf" -- Can be .self or .elf
targetExtensionExePSP2 = ".elf" -- Can be .self or .elf
...
flagsStatic = { "StaticRuntime", "NoImportLib" }

flagsAllWindows = { "WinMain", "NoImportLib" }
...
flagsAllXbox360 = { flagsStatic, "VSNoSubSystem", "NoExceptions", "NoIncrementalLink", "NoMinimalRebuild", "WinMain", "FatalWarnings", "VSNoStringPooling", "VSNoCOMDATFolding", "VSNoOptimizeReferences" }
flagsDebugXbox360 = { flagsAllXbox360, "Symbols" }
flagsReleaseXbox360 = { flagsAllXbox360, "OptimizeSpeed" }

flagsAllPS3 = { flagsStatic, "VSNoSubSystem", "WinMain" }
flagsDebugPS3 = { flagsAllPS3, "VSBufferSecurityCheck" }
flagsReleasePS3 = { flagsAllPS3 }

flagsAllPSP2 = { flagsStatic, "VSNoSubSystem", "WinMain" }
flagsDebugPSP2 = { flagsAllPSP2, "VSBufferSecurityCheck" }
flagsReleasePSP2 = { flagsAllPSP2, "NoIncrementalLink" }

-- Additional build options ---
buildOptAllWin = "" -- Typical build option
buildOptAllDebugWin =   ""
...
buildOptAllPS3 = ""
buildOptDebugPS3 =   "-g -Xc-=rtti -Xquit=1 -Xsingleconst=0"
buildOptReleasePS3 = "-O2 -Xc-=rtti -Xquit=1 -Xsingleconst=0 -Xfastmath=1 -Xassumecorrectalignment=1 -Xassumecorrectsign=1 -Xnotocrestore=2 -Xbranchless=1 -Xunrollssa=10"

buildOptAllPSP2 = ""
buildOptDebugPSP2 =   "-g -Xquit=1"
buildOptReleasePSP2 = "-O2 -Xquit=1 -Xfastmath=1 -Xc-=rtti"
...
postBuildNoXI = ""
postBuildNoXIX64 = ""
postBuildXbox360 =  { "xbcp  /D /Y /R  /T  ..\\..\\shared\\data\\base\\*.*  $(XBOX_DEPLOY_ROOT)\\Common",
					"xbcp  /D /Y /R  /T  ..\\Data\\Maps\\ViewerMap\\*.*  $(XBOX_DEPLOY_ROOT)\\Data\\Maps\\ViewerMap" }
postBuildPS3 = ""
postBuildPSP2 = ""
...
linkOptDebugPS3 = "-oformat=fself"
linkOptReleasePS3 = "-s -strip-unused-data --notocrestore -oformat=fself"

linkOptDebugPSP2 = ""
linkOptReleasePSP2 = "-s -strip-unused-data"
...
disableWarningsDebugPSP2 = { "1011", "1783", "237" }
disableWarningsReleasePSP2 = { "1011", "1783", "237" }
...
sourceHeaderPCHXbox360 = "../Source/projectname/StdAfx.h" -- Sets the correct precompiled header option for Xbox360 when using property sheets.
sourceHeaderPCH = ""
sourcePCH = "../Source/projectname/StdAfx.cpp" -- set this manually! replace 'projectname'
sourcesNotUsingPCH = { "" }

 -- PROCESSED BY VS2PREMAKE.   
excludedSourcesWindows = { "" } 
